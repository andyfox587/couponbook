  ...
  <div class="banner-manager">
    ...
    <div class="bm-field">
      <div class="bm-label-row">
        ...
        <span class="bm-hint">Header at the top of your event page · recommended 1800 × 560 px (wide landscape, ~3.2:1)</span>
      </div>
      ...
      <label v-else class="bm-dropzone" :class="{ loading: bannerUploading }">
        ...
        <span class="bm-dz-hint">Recommended 1800 × 560 px · PNG, JPG, WebP · max 5 MB</span>
        <input type="file" accept="image/*" class="bm-input" :disabled="bannerUploading" @change="onBannerChange" />
      </label>
    </div>
    ...
    <div class="bm-field">
      <div class="bm-label-row">
        ...
        <span class="bm-hint">Shown on event cards · recommended 900 × 480 px (landscape, 15:8)</span>
      </div>
      ...
      <label v-else class="bm-dropzone" :class="{ loading: coverUploading }">
        ...
        <span class="bm-dz-hint">Recommended 900 × 480 px · PNG, JPG, WebP · max 5 MB</span>
        <input type="file" accept="image/*" class="bm-input" :disabled="coverUploading" @change="onCoverChange" />
      </label>
    </div>
